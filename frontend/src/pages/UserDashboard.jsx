      ...
      <main className="mx-auto max-w-5xl px-4 py-10">
        <div className="rounded-xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <form onSubmit={submit} className="mt-6 grid gap-4 rounded-xl bg-slate-50 p-5 sm:grid-cols-2">
            <label className="text-sm font-medium">Target server<input required value={form.target_system} onChange={(e) => setForm({ ...form, target_system: e.target.value })} placeholder="rhel-lab" className="mt-1 w-full rounded border border-slate-300 px-3 py-2" /></label>
